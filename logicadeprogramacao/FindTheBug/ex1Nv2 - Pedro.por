...
programa
{
	...
	funcao inicio()
	{
		...
		se(mediaPonderada > 10){
			escreva("Dados Incorretos")
		}senao se(mediaPonderada >= 8){
			escreva("Sua Nota será: A")
		}senao se(mediaPonderada >= 7){
			escreva("Sua Nota será: B")
		}senao se(mediaPonderada >= 6){
			escreva("Sua Nota será: C")
		}senao se(mediaPonderada > 5){
			escreva("Sua Nota será: D")
		}senao se (mediaPonderada >= 0){
			escreva("Sua Nota será: E")
		}senao se(mediaPonderada < 0){
			escreva("Dados Incorretos")
		}
	}
